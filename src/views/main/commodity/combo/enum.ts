...
export const options = {
  ...
  //"doc_m_type": "套餐类型，1:原料分类,2:设备,3:服务",
  m_type_data : [
    { value: 1, label: '原料分类' },
    { value: 2, label: '设备' },
    { value: 3, label: '服务' },
  ...
  //拆单子类型
  // "doc_m_split_sub_type": "拆单子类型。1:套餐小类2:日期。",
  ...
  //销售类型
  //"doc_m_sell_type": "，1:普通套餐,2:预售套餐。",
  m_sell_type_data : [
    { value: 1, label: '普通套餐' },
    { value: 2, label: '预售套餐' },
  ],

  // "doc_m_source_type": "套餐来源类型，1:自建,2:sap。",
  m_source_type_data : [
    { value: 1, label: '自建' },
    { value: 2, label: 'sap' },
  ],
