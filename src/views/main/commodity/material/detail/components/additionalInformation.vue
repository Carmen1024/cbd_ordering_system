<template>
  <div class="formContainer">
    <el-form ref="additionalInformationForm" :model="form" :rules="rules" label-width="120px">
      <el-form-item label="商品描述" style="width:100%;" prop="m_s_desc">
        <el-input
      ...
      <el-form-item label="品牌" style="width:33%;" prop="m_s_brand">
        <el-select v-model="form.m_s_brand" clearable placeholder="请选择商品类型">
          <el-option
      ...
      <el-form-item label="产地" style="width:33%;" prop="m_s_origin_place">
        <el-select v-model="form.m_s_origin_place" clearable placeholder="请选择商品类型">
          <el-option
      ...
      <el-form-item label="等级" style="width:33%;" prop="m_s_grade">
        <el-select v-model="form.m_s_grade" clearable placeholder="请选择商品类型">
          <el-option
      ...
      <el-form-item label="商品主图" style="width:100%;">
        <el-upload
  ...
  // do not use same name with ref
    ...
    setup(props){
      ...
      const rules = reactive({
        ...
        // m_s_desc: [{ required: true, message: '商品名称不可为空', trigger: 'blur' }],
