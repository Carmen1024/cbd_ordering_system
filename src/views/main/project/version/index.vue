<template>
  <div class="layout-container">
    ...
    <div class="layout-container-table">
      ...
      >
        <el-table-column prop="number" label="版本号" align="center" />
        <el-table-column prop="chooseName" label="发布时间" align="center" />
        <el-table-column prop="dateName" label="参与人员" align="center" />
        <el-table-column prop="dateName" label="版本更新内容" align="center" />
