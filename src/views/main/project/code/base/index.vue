  ...
  <div class="layout-container">
    <div class="layout-container-form flex space-between">
      <div class="layout-container-form-handle">
        <el-input v-model="query.like.f_name" placeholder="请填写接口名称" @change="getTableData(true)"></el-input>
        <el-input v-model="query.like.f_path" placeholder="请填写接口路径" @change="getTableData(true)"></el-input>
      ...
      <!-- 接口名称 接口路径 -->
        ...
        <el-table-column :label="$t('message.common.handle')" align="center" fixed="right" width="300">
          <template #default="scope">
            ...
            <el-button @click="handleTest(scope.row)">接口测试</el-button>
