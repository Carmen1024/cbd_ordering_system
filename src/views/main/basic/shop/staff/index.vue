...
export default defineComponent({
  ...
  setup() {
    ...
    const columnData = ref([
      {prop:'name',label:"员工编码",width:""},
      {prop:'name',label:"姓名",width:"100"},
      {prop:'name',label:"登录账号",width:""},
      {prop:'name',label:"联系电话",width:""},
      {prop:'name',label:"所属门店",width:""},
      {prop:'name',label:"状态",width:""},
      {prop:'name',label:"身份",width:""},
      {prop:'name',label:"配置时间",width:""},
    ])
    // 获取表格数据
