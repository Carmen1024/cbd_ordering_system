<template>
  <div class="layout-container-tab">
    ...
    <div class="layout-container-table">
      ...
      >
      <!--  -->
        <el-table-column prop="name" label="账号类型" align="center" />
        <el-table-column prop="number" label="姓名" align="center" />
        <el-table-column prop="chooseName" label="账号" align="center" />
        <el-table-column prop="dateName" label="角色" align="center" />
        ...
        <el-table-column :label="$t('message.common.handle')" align="center" fixed="right" width="300">
          <template #default="scope">
            ...
            <el-popconfirm :title="'是否确认重置密码？'" @confirm="handleResetPass([scope.row])">
              <template #reference>
